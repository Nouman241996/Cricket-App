...
import TotalBalance from '../../Component/totalBalance/totalBalance'
import AmountCard from '../../Component/amountCards/amountCard'
...
const timestamp = currentDate.getTime();
  ...
  const postWithdrawAmount=()=>{
    ...
    then((res) => {
      ...
      console.log("res",parseData.message)
      toggleModal()
      setWithDrawAmount('')
      getWalletDataFromApi()
    ...
    <SafeAreaView style={styles.container}>
       ...
       profileImage={userData.image}/> 
        ...
        >
          ...
          loader={isLoad}
          toolTipText={'Winning'}
          actionOnpress={()=>{toggleModal(),setWithDrawAmount('')}}
          />
      ...
      >
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'flex-end' }}>
            <TouchableOpacity
              ...
              onPress={() =>{ toggleModal(),setWithDrawError(false)}}>
