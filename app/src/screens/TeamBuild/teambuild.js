...
class Teambuild extends Component {
  ...
  componentDidMount() {
    // this._reset_team_data();
console.log("team names is:",   "team1shortname1",this.props.route.params.team1shortname1,
"team2shortname2", this.props.route.params.team2shortname2,)
 ...
 Toast.show({
  ...
  _selectteam = (item) => {
    ...
    if (
      ...
      if (item.team_number == 1) {
        ++this.state.teamOneLength;
      } else if (item.team_number == 2) {
  ...
  render() {
    ...
    if (this.state.status == '') {
      this.state.status = t('common:pick')+' 1-4 ' + t('common:wicketKeeper');
    }
        ...
        <View style={{flex: 1, backgroundColor: Colors.mainbackground}}>
          ...
          <LinearGradient
                  ...
                  onPress={() => {
                    ...
                    if (this.props.route.params.type == 'bottomtabs') {
                      this.props.navigation.navigate('Captians', {
                        ...
                        team1shortname1:this.props.route.params.team1shortname1,
                        team2shortname2:this.props.route.params.team2shortname2,
                        headertext:
                          this.props.route.params.team1shortname1 +
                          ' VS ' +
                          this.props.route.params.team2shortname2,
                          callback:this.callbackReset.bind(this)
                      });
            ...
            <View style={styles.buildTeamHeadingView}>
              <View>
                <Text style={styles.buildTeamText}>{t('common:buildYourTeam')}</Text>
              </View>
              <View>
            ...
            <View style={styles.selectedResetMainView}>
              <View>
                ...
                <Text style={styles.SelectedplayerText}>{t('common:players')}</Text>
              </View>
              ...
              {this.state.result == [] ? null : (
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    ...
                    <View style={styles.vsView}>
                      <Text style={styles.countryVsCountryTextVS}>{t('homePage:vs')}</Text>
                    </View>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Image
                        resizeMode="contain"
                ...
                <View style={{flex: 1}}>
                  ...
                  <View
                    ...
                    <Text
                      ...
                      {this.state.total_player_selected} / 11 {t('common:playerSelected')}
                    </Text>
                  </View>
                </View>
              </SafeAreaView>
            ...
            <RBSheet
              ...
              <View style={{flex: 1}}>
                <View
                  ...
                  <Text style={styles.backModalGobacktext}>{t('common:goBack')} ?</Text>
                </View>
                <View
                  style={{
                    flexDirection: 'row',
                ...
                <View
                  ...
                  <TouchableOpacity
                    ...
                    <Text style={styles.backModaltext}>{t('common:discardTeam')} </Text>
                  </TouchableOpacity>
                </View>
                <View
                  style={{
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(Teambuild));
