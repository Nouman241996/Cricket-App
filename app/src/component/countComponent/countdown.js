...
class CountDown extends React.Component {
  ...
  renderCountDown = () => {
    ...
    return (
      ...
      >
        {timeToShow.includes('D') && newTime[0]!=0? this.renderDoubleDigits(timeLabels.d, newTime[0]) : null}
        {showSeparator &&  timeToShow.includes('D') && timeToShow.includes('H') &&  newTime[0]!=0 ? this.renderSeparator() : null}
        {timeToShow.includes('H')  && newTime[1]!=0 ? this.renderDoubleDigits(timeLabels.h, newTime[1]) : null}
        {showSeparator  && newTime[1]!=0 && timeToShow.includes('H') && timeToShow.includes('M') ? this.renderSeparator() : null}
        {timeToShow.includes('M')  && newTime[2]!=0 ? this.renderDoubleDigits(timeLabels.m, newTime[2]) : null}
        {showSeparator  && newTime[2]!=0 && timeToShow.includes('M') && timeToShow.includes('S') ? this.renderSeparator() : null}
        {timeToShow.includes('S')   && newTime[3]!=0 ? this.renderDoubleDigits(timeLabels.s, newTime[3]) : null}
      </Component>
    );
  };
